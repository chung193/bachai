                            ...
                            <ul class="list-group list-group-flush list my--3">
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
    <a href="#" class="avatar">
        <img class="rounded" alt="Image placeholder" src="{{asset('admin/assets/img/team/profile-picture-1.jpg')}}" />
    </a>
</div>
...
<li class="list-group-item px-0">
    <div class="row align-items-center">
        <div class="col-auto">
            <a href="#" class="avatar">
                <img class="rounded" alt="Image placeholder" src="{{asset('admin/assets/img/team/profile-picture-2.jpg')}}" />
            </a>
        </div>
        <div class="col-auto ms--2">
            <h4 class="h6 mb-0">
...
<li class="list-group-item px-0">
    <div class="row align-items-center">
        <div class="col-auto">
            <a href="#" class="avatar">
                <img class="rounded" alt="Image placeholder" src="{{asset('admin/assets/img/team/profile-picture-3.jpg')}}" />
            </a>
        </div>
        <div class="col-auto ms--2">
            <h4 class="h6 mb-0">
...
<li class="list-group-item px-0">
    <div class="row align-items-center">
        <div class="col-auto">
            <a href="#" class="avatar">
                <img class="rounded" alt="Image placeholder" src="{{asset('admin/assets/img/team/profile-picture-4.jpg')}}" />
            </a>
        </div>
        <div class="col-auto ms--2">
            <h4 class="h6 mb-0">
